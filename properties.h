...
public:
	...
	bool get_string(const std::string& name, std::string& value) { return get(name, value); }
	void set_int(const std::string& name, int value) { set(name, value); }
	bool get_int(const std::string& name, int& value) { return get(name, value); }
	void set_float(const std::string& name, float value) { set(name, value); }
	bool get_float(const std::string& name, float& value) { return get(name, value); }
	void set_bool(const std::string& name, bool value) { set(name, value); }
	bool get_bool(const std::string& name, bool& value) { return get(name, value); }
	void set_entity(const std::string& name, entt::entity value) { set(name, value); }
	bool get_entity(const std::string& name, entt::entity& value) { return get(name, value); }
...
template<typename T>
inline bool Properties::get(const std::string& name, T& value)
{
	// Do a binary search to find the property with the given name.
	auto it = std::ranges::lower_bound(_properties, name, {}, &Property::first);
